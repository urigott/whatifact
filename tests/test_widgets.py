...
class TestContinuous(unittest.TestCase):
    def setUp(self):
        ...
        self.v1 = dict(id='id', caption='caption', min=1, max=10, value=3, step=1, null=True)
        self.v2 = dict(id='id', caption='caption', min=1, max=10, value=3, step=1, null=False)
...
class TestCategorical(unittest.TestCase):
    def setUp(self):        
        self.v = dict(id='id', caption='caption', options=['a', 'b', 'c'], value='b', null=False)
